...
var taskFormHandler = function(event) {
    ...
    //has data attribute, so create object as normal and pass to createTaskEl function
    if (isEdit) {
        var taskId = formEl.getAttribute("data-task-id");
        completeEditTask(taskNameInput, taskTypeInput, taskId);
    }
    //no data attribute, so create product as normal and pass to cretaeTaskEl function
    else {
        var taskDataObj = {
            name: taskNameInput,
            type: taskTypeInput,
...
//Iterate through a task array and create task elementson the page from it
